...
#
# RESUME : SDSS DR15 Image Downloader Script
#    
# Version: v01
#
...
echo
echo "####################################################"
echo "# Welcome to the SDSS DR15 Image Downloader Script #"
echo "#  This script allows you to download images from  #"
echo "#     the Sloan Digital Sky Survey (SDSS) DR15     #"
echo "####################################################"
echo
...
if [ -n "$1" ]; then
	...
	# Image cut-off
	link="http://skyserver.sdss.org/dr15/SkyServerWS/ImgCutout/getjpeg?ra=$ra&dec=$dec&scale=$scale&width=$width&height=$height&opt=$opt"
    ...
    echo "####################################################"
    echo "#     Version 01 -- SDSS DR15 - How to use it?     #"
    echo "#       Script to get SDSS images from DR15        #"
    ...
    printf "\n\t Default scale for SDSS DR15 is 0.1\n\t Default options are '$default_opts'\n\n"
